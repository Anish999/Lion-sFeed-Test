...
namespace LionsFeed.Controllers
{
    ...
    public class ApplicationUsersController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,FirstName,Role,LastName,Email,Password,Gender,PhoneNumber,ImageUrl")] ApplicationUser applicationUser)
        {
